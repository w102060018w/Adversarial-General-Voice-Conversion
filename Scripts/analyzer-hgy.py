...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  5 10:43:03 2017
...
tf.app.flags.DEFINE_string('dir_to_wav', '/home/chadyang/CEDL/final/dataset/DS_10283_2042/wav', 'Dir to *.wav')
tf.app.flags.DEFINE_string('dir_to_bin', '/home/chadyang/CEDL/final/Features/SUPERSEDED-The-Voice-Conversion-Challenge-2016/pkl3', 'Dir to output *.bin')
tf.app.flags.DEFINE_integer('fs', 16000, 'Global sampling frequency')
tf.app.flags.DEFINE_float('f0_ceil', 500, 'Global f0 ceiling')

EPSILON = 1e-10
SETS = ['vcc2016_training', 'evaluation_release']  # TODO: for VCC2016 only
SPEAKERS = [s.strip() for s in tf.gfile.GFile('/home/chadyang/CEDL/final/Scripts/SPEAKERS.tsv', 'r').readlines()]
FFT_SIZE = 1024
SP_DIM = FFT_SIZE // 2 + 1
        ...
        for s in speakers:
            ...
            for f in os.listdir(path):
                ...
                if not os.path.isdir(filename):
                    ...
                    joblib.dump(features, join(output_dir, '{}.pkl'.format(b))) # hgy, 17/12/5, use pkl for storage
                    '''
