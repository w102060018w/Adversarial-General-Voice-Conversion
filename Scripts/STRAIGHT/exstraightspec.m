...
xamp=std(xold);
scaleconst=2200; % 2200 magic number for compatibility 15/Jan./2005
...
prm.defaultFrameLength = 40; %framem=40;	% default frame length for pitch extraction (ms)×Ô¼ºÐÞ¸Ä
