...
for ALPHA in ALPHAS:
    for LAMBDA in LAMBDAS:
        # architecture
        netE, netG, netD = architecture.vaewgan_dnn_v1(HIDDIM)
...
#            KLD_t = torch.sum(KLD_element_t).mul_(-0.5)
        ...
        #%% Save model
        savePath = '/home/chadyang/CEDL/final/Scripts/model/vaegan-dnn{}-{}-{}-{}-{}-{}-{}-{}-{}.pkl'.format( 'v2' ,SRC, TRG, ALLITER, VAEITER, BATCHSIZE, HIDDIM, LAMBDA, ALPHA )
...
#            plt.show()        
            ...
            plt.legend()
            plt.show()
            pltPath = '/home/chadyang/CEDL/final/Scripts/model/vaegan-dnn{}-{}-{}-{}-{}-{}-{}-{}-{}.png'.format('v2',SRC, TRG, ALLITER, VAEITER, BATCHSIZE, HIDDIM, LAMBDA, ALPHA)
        ...
        if GENERATE:
            ...
            oFilename = os.path.join(OUTWAVROOT, '{}-{}-{}-{}-{}-{}-{}-{}-{}-{}.wav'.format('v2',SRC, TRG, 100002, ALLITER, VAEITER, BATCHSIZE, HIDDIM, LAMBDA, ALPHA))
